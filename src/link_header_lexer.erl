-file("/usr/local/Cellar/erlang/R15B02/lib/erlang/lib/parsetools-2.0.7/include/leexinc.hrl", 0).
...
-module(link_header_lexer).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/link_header_lexer.xrl", 21).
...
-file("/usr/local/Cellar/erlang/R15B02/lib/erlang/lib/parsetools-2.0.7/include/leexinc.hrl", 14).
...
-file("src/link_header_lexer.erl", 281).
yystate() -> 9.
...
yystate(9, [37|Ics], Line, Tlen, Action, Alen) ->
...
yystate(9, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 32 ->
    yystate(11, Ics, Line, Tlen+1, Action, Alen);
...
yystate(2, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(2, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 59 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(2, [C|Ics], Line, Tlen, Action, Alen) when C >= 63 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/link_header_lexer.xrl", 11).
yyaction_0(TokenChars, TokenLen, TokenLine) ->
     { token, { uri, TokenLine, strip (TokenChars, TokenLen) } } .

-compile({inline,yyaction_1/2}).
-file("src/link_header_lexer.xrl", 12).
yyaction_1(TokenChars, TokenLine) ->
     { token, { semicolon, TokenLine, atom (TokenChars) } } .

-compile({inline,yyaction_2/2}).
-file("src/link_header_lexer.xrl", 13).
yyaction_2(TokenChars, TokenLine) ->
     { token, { key, TokenLine, TokenChars } } .

-compile({inline,yyaction_3/2}).
-file("src/link_header_lexer.xrl", 14).
yyaction_3(TokenChars, TokenLine) ->
     { token, { eq, TokenLine, atom (TokenChars) } } .

-compile({inline,yyaction_4/3}).
-file("src/link_header_lexer.xrl", 15).
yyaction_4(TokenChars, TokenLen, TokenLine) ->
     { token, { value, TokenLine, strip (TokenChars, TokenLen) } } .

-compile({inline,yyaction_5/2}).
-file("src/link_header_lexer.xrl", 16).
yyaction_5(TokenChars, TokenLine) ->
     { token, { comma, TokenLine, atom (TokenChars) } } .

-compile({inline,yyaction_6/0}).
-file("src/link_header_lexer.xrl", 17).
yyaction_6() ->
     skip_token .

-file("/usr/local/Cellar/erlang/R15B02/lib/erlang/lib/parsetools-2.0.7/include/leexinc.hrl", 282).
